...
// 
// File: AddConstraintSchemaWorkUnit.cs
...
namespace BootFX.Common.Data.Schema
{
	...
	/// </summary>
	internal class AddConstraintSchemaWorkUnit : SchemaColumnWorkUnit
	{		
		...
		internal AddConstraintSchemaWorkUnit(EntityType entityType,SqlColumn column, SqlDatabaseDefault defaultExpression) : base(entityType,column)
		{

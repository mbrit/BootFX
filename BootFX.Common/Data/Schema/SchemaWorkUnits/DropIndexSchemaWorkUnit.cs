...
// 
// File: DropIndexSchemaWorkUnit.cs
...
namespace BootFX.Common.Data.Schema
{
	...
	/// </summary>
	internal class DropIndexSchemaWorkUnit : SchemaWorkUnit
	{		
		/// <summary>
		...
		internal DropIndexSchemaWorkUnit(EntityType entityType,SqlTable table, SqlIndex index) : base(entityType)
		{
			_index = index;	
			_table = table;
		}
		...
		public override SqlStatement[] GetStatements(WorkUnitProcessingContext context)
		{
			...
			return SqlStatement.CreateStatements(context.Dialect.GetDropIndexStatement(this.Table,this.Index));
		}

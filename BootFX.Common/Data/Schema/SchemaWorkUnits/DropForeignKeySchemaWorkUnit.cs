...
// 
// File: DropForeignKeySchemaWorkUnit.cs
...
{
	/// <summary>
	/// Defines a work unit that can drop and index from a table.
	/// </summary>
	internal class DropForeignKeySchemaWorkUnit : SchemaWorkUnit
	{		
		/// <summary>
		...
		internal DropForeignKeySchemaWorkUnit(EntityType entityType, SqlChildToParentLink foreignKey) : base(entityType)
		{
		...
		public override SqlStatement[] GetStatements(WorkUnitProcessingContext context)
		{
			...
			return SqlStatement.CreateStatements(context.Dialect.GetDropForeignKeyStatement(this.ForeignKey));
		}
